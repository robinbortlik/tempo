            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-stone-500">
                  ...
                  {project.hourly_rate && ` ${t("pages.projects.customRate")}`}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              >
                {isToggling
                  ? t("common.updating")
                  : project.active
                    ? t("pages.projects.deactivate")
                    : t("pages.projects.activate")}
              </Button>
              <Button
                variant="outline"
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>
                      {t("pages.projects.deleteTitle", { name: project.name })}
                    </AlertDialogTitle>
                    <AlertDialogDescription>
                      {t("pages.projects.deleteDescription")}
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
            ...
            <TableHeader>
              <TableRow className="text-left text-sm text-stone-500 border-b border-stone-200">
                <TableHead className="px-6 py-4 font-medium">
                  {t("pages.workEntries.table.date")}
                </TableHead>
                <TableHead className="px-6 py-4 font-medium">
                  {t("pages.workEntries.table.description")}
                </TableHead>
                <TableHead className="px-6 py-4 font-medium text-right">
                  {t("pages.workEntries.table.hours")}
                </TableHead>
                <TableHead className="px-6 py-4 font-medium text-right">
                  {t("pages.workEntries.table.amount")}
                </TableHead>
                <TableHead className="px-6 py-4 font-medium">
                  {t("pages.workEntries.table.status")}
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {work_entries.length === 0 ? (
                <TableRow>
                  ...
                  >
                    {t("pages.projects.noWorkEntries")}
                  </TableCell>
                </TableRow>
              ) : (
