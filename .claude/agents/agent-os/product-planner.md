...
tools: Write, Read, Bash, WebFetch, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
color: cyan
model: inherit
---
...
- Information about libraries, frameworks, or tools for tech stack documentation
- Setup or configuration guidance for technologies
- Library or API documentation reference
- Understanding capabilities of specific technologies
...
**Do this automatically** without being explicitly asked - especially when documenting tech stack choices or evaluating technology options.
